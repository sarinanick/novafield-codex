...
format: ".mdc"
stack: "React, Next.js, UI development"
...
## Best for
Use for building complete Next.js UI screens, components, and layouts.
...
```text
Use `React Next.js UI Development` as the frontend/UI guidance for this task. Follow its conventions for component structure, styling, accessibility, responsive behavior, and design consistency. Prefer reusable components, semantic markup, clear loading/error/empty states, and production-ready UI polish.
```
