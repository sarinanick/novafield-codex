...
## Best for
Use to keep shadcn components aligned with Tailwind theme, semantic colors, spacing, and variants.
...
```text
Use `Tailwind shadcn ui Integration` as the frontend/UI guidance for this task. Follow its conventions for component structure, styling, accessibility, responsive behavior, and design consistency. Prefer reusable components, semantic markup, clear loading/error/empty states, and production-ready UI polish.
```
