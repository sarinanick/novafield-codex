...
format: ".mdc"
stack: "React components, props, composition"
...
## Best for
Use to guide agents to create reusable, composable React UI components.
...
```text
Use `React Components Creation` as the frontend/UI guidance for this task. Follow its conventions for component structure, styling, accessibility, responsive behavior, and design consistency. Prefer reusable components, semantic markup, clear loading/error/empty states, and production-ready UI polish.
```
