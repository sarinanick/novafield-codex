...
format: ".mdc"
stack: "Next.js, Material UI, Tailwind CSS"
...
## Best for
Use for hybrid component systems that combine MUI components with Tailwind layout utilities.
...
```text
Use `Next.js Material UI Tailwind CSS` as the frontend/UI guidance for this task. Follow its conventions for component structure, styling, accessibility, responsive behavior, and design consistency. Prefer reusable components, semantic markup, clear loading/error/empty states, and production-ready UI polish.
```
